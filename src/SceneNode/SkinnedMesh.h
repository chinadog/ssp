...
#include <irrlicht.h>
#include "InterfaceSkinnedMesh.h"
using namespace irr;

class IAnimatedMeshSceneNode;
class IBoneSceneNode;

class SkinnedMesh: public InterfaceSkinnedMesh
{
public:
    ...
    virtual scene::E_ANIMATED_MESH_TYPE getMeshType() const;
    ...
    virtual bool useAnimationFrom(const InterfaceSkinnedMesh *mesh);
    ...
    virtual void setInterpolationMode(scene::E_INTERPOLATION_MODE mode);
    ...
    virtual core::array<scene::SSkinMeshBuffer*> &getMeshBuffers();
    ...
    virtual scene::SSkinMeshBuffer *addMeshBuffer();
    ...
    void recoverJointsFromMesh(core::array<scene::IBoneSceneNode*> &jointChildSceneNodes);

    //! Tranfers the joint data to the mesh
    void transferJointsToMesh(const core::array<scene::IBoneSceneNode*> &jointChildSceneNodes);

    //! Tranfers the joint hints to the mesh
    void transferOnlyJointsHintsToMesh(const core::array<scene::IBoneSceneNode*> &jointChildSceneNodes);

    //! Creates an array of joints from this mesh as children of node
    void addJoints(core::array<scene::IBoneSceneNode*> &jointChildSceneNodes,
...
private:
    ...
    core::array<scene::SSkinMeshBuffer*> *SkinningBuffers; //Meshbuffer to skin, default is to skin localBuffers

    core::array<scene::SSkinMeshBuffer*> LocalBuffers;
    ...
    scene::E_INTERPOLATION_MODE InterpolationMode:8;
