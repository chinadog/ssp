#ifndef ANIMATEDMESHSCENENODE_H
#define ANIMATEDMESHSCENENODE_H
...
class AnimatedMeshSceneNode : public scene::IAnimatedMeshSceneNode
{
public:
    ...
    virtual void setAnimationEndCallback(scene::IAnimationEndCallBack* callback=0);
    ...
    virtual scene::IBoneSceneNode* getJointNode(const c8* jointName);

    //! same as getJointNode(const c8* jointName), but based on id
    virtual scene::IBoneSceneNode* getJointNode(u32 jointID);
    ...
    virtual bool setMD2Animation(scene::EMD2_ANIMATION_TYPE anim);
    ...
    virtual scene::IAnimatedMesh* getMesh(void) { return Mesh; }
    ...
    virtual scene::ESCENE_NODE_TYPE getType() const { return scene::ESNT_ANIMATED_MESH; }

    // returns the absolute transformation for a special MD3 Tag if the mesh is a md3 mesh,
    // or the absolutetransformation if it's a normal scenenode
    const scene::SMD3QuaternionTag* getMD3TagTransformation( const core::stringc & tagname);
    ...
    virtual void setJointMode(scene::E_JOINT_UPDATE_ON_RENDER mode);
...
private:
    ...
    scene::IMesh* getMeshForCurrentFrame();
    ...
    scene::E_JOINT_UPDATE_ON_RENDER JointMode;
    bool JointsUsed;
    ...
    scene::IAnimationEndCallBack* LoopCallBack;
    s32 PassCount;

    scene::IShadowVolumeSceneNode* Shadow;

    core::array<scene::IBoneSceneNode* > JointChildSceneNodes;
    ...
    struct SMD3Special : public virtual IReferenceCounted
    {
        ...
        scene::SMD3QuaternionTagList AbsoluteTagList;
