#ifndef INTERFACESKINNEDMESH_H
#define INTERFACESKINNEDMESH_H
...
class InterfaceSkinnedMesh : public scene::IAnimatedMesh
{
public:
    ...
    virtual bool useAnimationFrom(const InterfaceSkinnedMesh *mesh) = 0;
    ...
    virtual core::array<scene::SSkinMeshBuffer*>& getMeshBuffers() = 0;
    ...
    virtual scene::SSkinMeshBuffer* addMeshBuffer() = 0;
