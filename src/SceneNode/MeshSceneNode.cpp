...
//! constructor
MeshSceneNode::MeshSceneNode(scene::IMesh* mesh, ISceneNode* parent, scene::ISceneManager* mgr, s32 id,
...
bool MeshSceneNode::removeChild(ISceneNode* child)
{
...
const core::aabbox3d<f32>& MeshSceneNode::getBoundingBox() const
{
...
video::SMaterial& MeshSceneNode::getMaterial(u32 i)
{
...
u32 MeshSceneNode::getMaterialCount() const
{
...
//! Sets a new mesh
void MeshSceneNode::setMesh(scene::IMesh* mesh)
{
    if (mesh)
    {
        mesh->grab();
...
scene::IShadowVolumeSceneNode *MeshSceneNode::addShadowVolumeSceneNode(const scene::IMesh *shadowMesh, s32 id, bool zfailmethod, f32 infinity)
{
    (void)shadowMesh;
    (void)id;
    (void)zfailmethod;
...
void MeshSceneNode::serializeAttributes(io::IAttributes* out, io::SAttributeReadWriteOptions* options) const
{
...
void MeshSceneNode::deserializeAttributes(io::IAttributes* in, io::SAttributeReadWriteOptions* options)
{
...
bool MeshSceneNode::isReadOnlyMaterials() const
{
...
scene::ISceneNode* MeshSceneNode::clone(ISceneNode* newParent, scene::ISceneManager* newManager)
{
    if (!newParent)
        newParent = Parent;
    if (!newManager)
    ...
    MeshSceneNode* nb = new MeshSceneNode(Mesh, newParent,
